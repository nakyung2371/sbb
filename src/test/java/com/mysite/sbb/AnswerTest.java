...
public class AnswerTest {
	...
	//값 입력: question 테이블의 id = 1번 글에 대한 답변 3개 등록
	//@Test
	void jpaInsert() {
		
		//답변 테이블의 값은 질문 테이블의 ID를 참조해서 값을 넣음
		...
		a1.setContent("JPA는 ORM입니다 - SQL 쿼리를 사용하지 않고 자바의 클래스의 메소드를 사용해서 CRUD합니다");
		...
		a2.setContent("JPA는 인터페이스입니다. jpa 인터페이스를 구현한 구현 클래스가 하이버네이트입니다.");
	...
	void jpaInsert2() {
		...
		Answer a1 = new Answer();
		a1.setContent("자바를 기반으로 한 웹프레임 워크입니다.");
		a1.setCreateDate(LocalDateTime.now());
		a1.setQuestion(q1);
